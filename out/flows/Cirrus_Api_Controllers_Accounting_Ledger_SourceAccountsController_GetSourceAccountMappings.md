[web] GET /api/accounting/ledger/source-accounts/mappings  (Cirrus.Api.Controllers.Accounting.Ledger.SourceAccountsController.GetSourceAccountMappings)  [L90–L105] [auth=user]
