[web] POST /api/journals/{id}/excel-import  (Workpapers.Next.API.Controllers.Workpapers.JournalController.ImportFromExcelFile)  [L256–L264] status=201 [auth=AuthorizationPolicies.User]
  └─ sends_request ParseUploadedExcelFileToImportModelCommand -> ParseUploadedExcelFileToImportModelCommandHandler [L261]
  ...
  └─ sends_request CanIAccessBinderQuery -> CanIAccessBinderQueryHandler [L259]
  ...
  └─ impact_summary
    └─ requests 2
      ...
      └─ ParseUploadedExcelFileToImportModelCommand
    └─ handlers 2
      └─ CanIAccessBinderQueryHandler
      └─ ParseUploadedExcelFileToImportModelCommandHandler
    └─ caches 1
      └─ IMemoryCache
    └─ mappings 1
