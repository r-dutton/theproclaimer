[web] GET /api/ui/account-mapping/mapping-codes/{code}  (Dataverse.Api.Controllers.UI.AccountMapping.MappingCodesController.GetMappingCodeByCode)  [L44–L48] [auth=Authentication.UserPolicy]
