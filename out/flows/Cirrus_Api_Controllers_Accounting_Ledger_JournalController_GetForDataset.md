[web] GET /api/accounting/ledger/journals/for-dataset/{datasetId:Guid}  (Cirrus.Api.Controllers.Accounting.Ledger.JournalController.GetForDataset)  [L80–L103] [auth=user]
