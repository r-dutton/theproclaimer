[web] GET /api/binders/{id:Guid}/export-details  (Workpapers.Next.API.Controllers.Workpapers.BindersController.GetBinderExportedDetails)  [L462–L473] [auth=AuthorizationPolicies.User]
