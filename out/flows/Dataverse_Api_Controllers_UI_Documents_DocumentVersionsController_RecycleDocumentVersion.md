[web] DELETE /api/ui/documents/{documentId:guid}/versions/{documentVersionId:guid}  (Dataverse.Api.Controllers.UI.Documents.DocumentVersionsController.RecycleDocumentVersion)  [L91–L97] status=200 [auth=Authentication.UserPolicy]
  └─ sends_request RecycleDocumentVersionCommand -> RecycleDocumentVersionCommandHandler [L96]
  ...
  └─ sends_request CanIAccessDocumentQuery -> CanIAccessDocumentQueryHandler [L95]
  ...
  └─ impact_summary
    ...
    └─ requests 2
      ...
      └─ RecycleDocumentVersionCommand
    └─ handlers 2
      └─ CanIAccessDocumentQueryHandler
      └─ RecycleDocumentVersionCommandHandler
    └─ caches 2
      └─ IDistributedCache
      └─ IMemoryCache
