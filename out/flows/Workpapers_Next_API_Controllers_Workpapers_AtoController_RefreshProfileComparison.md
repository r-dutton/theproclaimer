[web] GET /api/ato/gov-link/profile-compare  (Workpapers.Next.API.Controllers.Workpapers.AtoController.RefreshProfileComparison)  [L180–L187] [auth=AuthorizationPolicies.User,AuthorizationPolicies.GovLink]
