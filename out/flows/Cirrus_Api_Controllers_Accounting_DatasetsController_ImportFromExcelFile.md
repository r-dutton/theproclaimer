[web] POST /api/accounting/datasets/{id}/excel-import  (Cirrus.Api.Controllers.Accounting.DatasetsController.ImportFromExcelFile)  [L142–L159] [auth=user]
  └─ calls DatasetRepository.WriteQuery [L150]
  └─ writes_to Dataset [L150]
