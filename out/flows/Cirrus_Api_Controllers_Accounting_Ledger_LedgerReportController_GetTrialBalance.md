[web] GET /api/accounting/ledger/reports/{datasetId}/trialbalance  (Cirrus.Api.Controllers.Accounting.Ledger.LedgerReportController.GetTrialBalance)  [L47–L70] [auth=user]
