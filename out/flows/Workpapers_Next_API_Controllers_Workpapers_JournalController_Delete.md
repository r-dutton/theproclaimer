[web] DELETE /api/journals/{id:guid}  (Workpapers.Next.API.Controllers.Workpapers.JournalController.Delete)  [L269–L277] status=200 [auth=AuthorizationPolicies.User]
  ...
  └─ uses_service JournalRepository
    └─ method WriteQuery [L272]
      └─ implementation Workpapers.Next.Data.Repository.Workpapers.JournalRepository.WriteQuery [L12-L72]
  └─ sends_request CanIAccessBinderQuery -> CanIAccessBinderQueryHandler [L273]
