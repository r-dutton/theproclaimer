[web] GET /api/super/support-users  (Dataverse.Api.Controllers.Super.Core.SupportUsersController.GetSupportUsersAsync)  [L26–L34] [auth=Authentication.MasterPolicy,Authentication.RequireTenantIdPolicy]
