[web] PUT /api/binder-sections/{id:Guid}  (Workpapers.Next.API.Controllers.Workpapers.BinderSectionsController.Update)  [L85–L98] [auth=AuthorizationPolicies.User]
