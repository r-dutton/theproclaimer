[web] GET /api/accounting/ledger/cashflow/journals/{id}  (Cirrus.Api.Controllers.Accounting.Ledger.Cashflow.CashflowJournalController.Get)  [L40–L49] [auth=Authentication.UserPolicy]
