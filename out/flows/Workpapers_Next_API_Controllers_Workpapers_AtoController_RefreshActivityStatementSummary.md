[web] GET /api/ato/gov-link/activity-statements/summary  (Workpapers.Next.API.Controllers.Workpapers.AtoController.RefreshActivityStatementSummary)  [L127–L134] [auth=AuthorizationPolicies.User,AuthorizationPolicies.GovLink]
