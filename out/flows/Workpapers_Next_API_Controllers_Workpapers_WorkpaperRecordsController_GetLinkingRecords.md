[web] GET /api/workpaper-records/linking-records  (Workpapers.Next.API.Controllers.Workpapers.WorkpaperRecordsController.GetLinkingRecords)  [L123–L144] [auth=AuthorizationPolicies.User]
