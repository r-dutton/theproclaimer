[web] DELETE /api/binder-sections/{id:Guid}  (Workpapers.Next.API.Controllers.Workpapers.BinderSectionsController.Delete)  [L100–L114] status=200 [auth=AuthorizationPolicies.User]
  └─ calls BinderSectionRepository (methods: Remove,WriteQuery) [L111]
  └─ delete BinderSection [L111]
    └─ reads_from BinderSections
  └─ write BinderSection [L103]
    └─ reads_from BinderSections
  └─ sends_request CanIDeleteBinderSectionQuery -> CanIDeleteBinderSectionQueryHandler [L109]
    └─ handled_by Workpapers.Next.ApplicationService.Queries.Workpapers.CanIDeleteBinderSectionQueryHandler.Handle [L17–L34]
  └─ sends_request CanIAccessBinderQuery -> CanIAccessBinderQueryHandler [L108]
  ...
  └─ impact_summary
    └─ entities 1 (writes=2, reads=0)
      └─ BinderSection writes=2 reads=0
    └─ requests 2
      └─ CanIAccessBinderQuery
      └─ CanIDeleteBinderSectionQuery
    └─ handlers 2
      └─ CanIAccessBinderQueryHandler
      └─ CanIDeleteBinderSectionQueryHandler
    └─ caches 1
      └─ IMemoryCache
