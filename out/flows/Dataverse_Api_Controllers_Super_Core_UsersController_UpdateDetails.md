[web] PUT /api/super/users/  (Dataverse.Api.Controllers.Super.Core.UsersController.UpdateDetails)  [L126–L132] [auth=Authentication.MasterPolicy,Authentication.RequireTenantIdPolicy]
