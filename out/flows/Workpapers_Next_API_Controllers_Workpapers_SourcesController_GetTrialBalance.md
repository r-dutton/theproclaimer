[web] PUT /api/sources/{type}/trial-balance  (Workpapers.Next.API.Controllers.Workpapers.SourcesController.GetTrialBalance)  [L205–L223] status=200 [auth=AuthorizationPolicies.User]
  ...
  └─ write Binder [L208]
    └─ reads_from Binders
  └─ sends_request ImportFromApiCommand -> ImportFromApiCommandHandler [L220]
  ...
  └─ sends_request CanIAccessBinderQuery -> CanIAccessBinderQueryHandler [L212]
