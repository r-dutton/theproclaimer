[web] POST /api/accounting/ledger/journals/balancing-journal/{datasetId}  (Cirrus.Api.Controllers.Accounting.Ledger.JournalController.Create)  [L187–L193] [auth=user]
