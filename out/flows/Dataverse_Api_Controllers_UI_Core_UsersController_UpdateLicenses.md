[web] PUT /api/ui/users/{id:guid}/licenses  (Dataverse.Api.Controllers.UI.Core.UsersController.UpdateLicenses)  [L252–L259] [auth=Authentication.UserPolicy,Authentication.AdminPolicy]
