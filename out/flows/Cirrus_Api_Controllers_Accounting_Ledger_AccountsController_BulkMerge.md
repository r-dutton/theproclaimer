[web] PUT /api/accounting/ledger/accounts/merge/bulk  (Cirrus.Api.Controllers.Accounting.Ledger.AccountsController.BulkMerge)  [L504–L510] status=200 [auth=user]
  └─ sends_request BulkMergeAccountsCommand -> BulkMergeAccountsCommandHandler [L508]
  ...
  └─ sends_request CanIAccessFileQuery -> CanIAccessFileQueryHandler [L507]
  ...
  └─ impact_summary
    └─ requests 2
      └─ BulkMergeAccountsCommand
      └─ CanIAccessFileQuery
    └─ handlers 2
      └─ BulkMergeAccountsCommandHandler
