[web] POST /api/accounting/reports/templates/export/download  (Cirrus.Api.Controllers.Accounting.Reports.ReportTemplatesController.ExportAs)  [L232–L239] [auth=user]
