[web] GET /api/accounting/datasets/{id}/preview-rollover-journal  (Cirrus.Api.Controllers.Accounting.DatasetsController.DraftRollover)  [L196–L202] [auth=user]
  └─ calls DatasetRepository.ReadQuery [L199]
  └─ queries Dataset [L199]
